...
const (
	StatisticService_Statistic_FullMethodName    = "/pbstatistic.StatisticService/Statistic"
	StatisticService_StatisticAll_FullMethodName = "/pbstatistic.StatisticService/StatisticAll"
)
...
func (c *statisticServiceClient) Statistic(ctx context.Context, in *StatisticReq, opts ...grpc.CallOption) (*StatisticResp, error) {
	...
	err := c.cc.Invoke(ctx, StatisticService_Statistic_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statisticServiceClient) StatisticAll(ctx context.Context, in *StatisticAllReq, opts ...grpc.CallOption) (*StatisticResp, error) {
	out := new(StatisticResp)
	err := c.cc.Invoke(ctx, StatisticService_StatisticAll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _StatisticService_Statistic_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StatisticService_Statistic_FullMethodName,
	}
...
func _StatisticService_StatisticAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StatisticService_StatisticAll_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
