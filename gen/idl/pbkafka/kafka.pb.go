...
type KafkaInstance struct {
	...
	// 节点标签值（见 CLOUD_FITTER_NODE_TAG_KEY，默认键名 node；各云若列表无标签则为空）
	NodeTagValue string `protobuf:"bytes,12,opt,name=node_tag_value,json=nodeTagValue,proto3" json:"node_tag_value,omitempty"`
	// 关联安全组（名称优先，否则 ID；腾讯 CKafka 列表接口暂无字段时为空）
	SecurityGroupNames []string `protobuf:"bytes,13,rep,name=security_group_names,json=securityGroupNames,proto3" json:"security_group_names,omitempty"`
	// 用户自定义「系统」标签键的值（CLOUD_FITTER_SYSTEM_TAG_KEY / 默认 system）；ShowKafkaTags 与列表合并
	...
	// 用户自定义标签展示：DMS Kafka ShowKafkaTags（key=value; 拼接）；失败时用列表 tags
	...
	// 环境标识：指定标签键的值（CLOUD_FITTER_ENV_TAG_KEY / CLOUD_FITTER_ECS_ENV_TAG_KEY，默认 environment）；无标签时按实例名推断
	EnvTagValue string `protobuf:"bytes,16,opt,name=env_tag_value,json=envTagValue,proto3" json:"env_tag_value,omitempty"`
}
...
func (x *KafkaInstance) GetNodeTagValue() string {
	if x != nil {
...
func (x *KafkaInstance) GetSecurityGroupNames() []string {
	if x != nil {
...
func (x *KafkaInstance) GetSystemTagsDisplay() string {
	if x != nil {
...
func (x *KafkaInstance) GetUserTagsDisplay() string {
	if x != nil {
...
func (x *KafkaInstance) GetEnvTagValue() string {
	if x != nil {
...
var file_idl_pbkafka_kafka_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd4, 0x04, 0x0a, 0x0d,
	...
	,
	...
	0x22, 0xd8, 0x01, 0x0a, 0x0e, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x52,
	...
	0x6b, 0x61, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x66, 0x69, 0x6e, 0x69, 0x73, 0x68, 0x65, 0x64, 0x18,
	...
	,
	...
	0x6e, 0x2f, 0x69, 0x64, 0x6c, 0x2f, 0x70, 0x62, 0x6b, 0x61, 0x66, 0x6b, 0x61, 0x62, 0x06, 0x70,
...
var file_idl_pbkafka_kafka_proto_goTypes = []any{
...
func file_idl_pbkafka_kafka_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_idl_pbkafka_kafka_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_idl_pbkafka_kafka_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_idl_pbkafka_kafka_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_idl_pbkafka_kafka_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_idl_pbkafka_kafka_proto_msgTypes[4].Exporter = func(v any, i int) any {
