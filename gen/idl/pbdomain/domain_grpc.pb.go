...
const (
	DomainService_ListDomainDetail_FullMethodName = "/pbdomain.DomainService/ListDomainDetail"
	DomainService_ListDomain_FullMethodName       = "/pbdomain.DomainService/ListDomain"
)
...
func (c *domainServiceClient) ListDomainDetail(ctx context.Context, in *ListDetailReq, opts ...grpc.CallOption) (*ListDetailResp, error) {
	...
	err := c.cc.Invoke(ctx, DomainService_ListDomainDetail_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DomainService_ListDomainDetail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DomainService_ListDomainDetail_FullMethodName,
	}
